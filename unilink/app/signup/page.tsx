      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-600">
            Start collaborating with students today
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="John"
                  className="mt-2 block w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-neutral-400 focus:outline-none focus:ring-1 focus:ring-neutral-400 transition-colors"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="relative mt-2">
                <input
                  ...
                  placeholder="••••••••"
                  className="block w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 pr-12 text-sm text-neutral-900 placeholder:text-neutral-400 focus:border-neutral-400 focus:outline-none focus:ring-1 focus:ring-neutral-400 transition-colors"
                />
                <button
                  type="button"
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50">
